...
class AppConfig {
  static const String appName     = 'MängelLog';
  static const String appId       = 'maengellog';
  static const String packageName = 'de.reivi.maengellog';
  static const IconData appIcon   = Icons.home_repair_service;

  static const int primaryColorValue = 0xFFE8641A;
  static const int accentColorValue  = 0xFF1A7A4E;
